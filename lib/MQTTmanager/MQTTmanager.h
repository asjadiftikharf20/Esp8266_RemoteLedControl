...
// EEPROM address
#define STATE_MESSAGE_EEPROM_ADDRESS 0
...
#define TEN_HOURS_IN_SECS 36000
#define TWENTY_FOUR_HOURS_IN_SECS 86400
#define NTP_SERVERS "pool.ntp.org", "time.nist.gov"
#define MQTT_PACKET_SIZE 1024

#define DEVICE_TWIN_REQUEST_INTERVAL_IN_HOURS 10

void connectToWiFi();
void establishConnect();
void MQTT_loop();
void requestDeviceTwin();
extern char telemetryString(String json_data);

unsigned const char ca_pem[] = {
...
unsigned const int ca_pem_len = 2557;
